...
export default function Hero() {
  return (
    <section className="relative h-[100vh] overflow-hidden pt-12">
      {/* Hero Content */}
      <div className="border-medium-gray relative z-20 mx-auto flex min-h-full max-w-[1152px] items-end border border-x border-y-0 px-4 py-8 pb-12 sm:items-center sm:px-6 lg:px-8">
        <motion.div
          className="relative z-20 flex max-w-xl flex-col gap-4 text-left sm:mx-auto"
        ...
        >
          {/* Main Heading */}
          <motion.div
            className="sm:text-5.5xl relative z-20 text-3xl"
